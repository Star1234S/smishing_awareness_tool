...
SMS_TASKS = [
    {
        "id": "sms01",
        "title": "SMS Message 1",
        "image": "images/sms01.png",
        "correct_answer": "Fake"
    },
    {
        "id": "sms02",
        "title": "SMS Message 2",
        "image": "images/sms02.png",
        "correct_answer": "Real"
    },
    {
        "id": "sms03",
        "title": "SMS Message 3",
        "image": "images/sms03.png",
        "correct_answer": "Fake"
    },
    {
        "id": "sms04",
        "title": "SMS Message 4",
        "image": "images/sms04.png",
        "correct_answer": "Real"
    },
    {
        "id": "sms05",
        "title": "SMS Message 5",
        "image": "images/sms05.png",
        "correct_answer": "Fake"
    },
    {
        "id": "sms06",
        "title": "SMS Message 6",
        "image": "images/sms06.png",
        "correct_answer": "Real"
    },
    {
        "id": "sms07",
        "title": "SMS Message 7",
        "image": "images/sms07.png",
        "correct_answer": "Fake"
    },
    {
        "id": "sms08",
        "title": "SMS Message 8",
        "image": "images/sms08.png",
        "correct_answer": "Real"
    },
    {
        "id": "sms09",
        "title": "SMS Message 9",
        "image": "images/sms09.png",
        "correct_answer": "Fake"
    },
    {
        "id": "sms10",
...
def save_to_google_sheet_via_apps_script(row_data):
    ...
    - Streamlit prevents saving twice in the same session.
    - Apps Script checks participant_id before appending a new row.
    """
...
def show_survey_page():
    ...
    with st.form("survey_form"):
        ...
        age_group = st.radio(
            ...
            ["18–24 years", "25–34 years", "35–44 years", "45–54 years", "55 years or older"],
            index=None
        )
        ...
        for number, task in enumerate(SMS_TASKS, start=1):
            ...
            if image_path.exists():
                ...
                st.warning(
                    f"Image not found: {task['image']}. "
                    "Please add this image inside the images folder."
                )
...
def show_result_page():
    ...
    if st.session_state.response_saved:
        st.success(
            "Your response has already been submitted. Thank you for taking part."
        )
    ...
    with st.form("evaluation_form"):
        ...
        save_button = st.form_submit_button(
            ...
            disabled=st.session_state.saving_in_progress
        )

    if save_button:

        if st.session_state.response_saved:
            st.warning("This response has already been submitted.")
            st.stop()
        ...
        try:
            ...
            if result.get("status") == "duplicate":
                st.success(
                    "Your response was already saved earlier. Thank you for taking part."
                )
            else:
                st.success(
